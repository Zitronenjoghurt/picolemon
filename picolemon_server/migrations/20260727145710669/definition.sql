...
--
-- Class GamePlayer as table game_player
--
...
-- Indexes
CREATE UNIQUE INDEX "game_player_room_seat_idx" ON "game_player" USING btree ("roomId", "seat");

--
-- Class GameRoom as table game_room
--
...
-- Indexes
CREATE UNIQUE INDEX "game_room_code_idx" ON "game_room" USING btree ("code");
...
--
-- Foreign relations for "game_player" table
--
ALTER TABLE ONLY "game_player"
    ADD CONSTRAINT "game_player_fk_0"
    FOREIGN KEY("roomId")
...
--
-- MIGRATION VERSION FOR picolemon
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('picolemon', '20260727145710669', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260727145710669', "timestamp" = now();
